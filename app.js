/* 
var h1 = React.createElement('h1', { className:'success' }, null, 'Hello');
...
var Layout = React.createClass({
    ...
    render: function(){
        return <div className="overlay">
                    ...
                    <footer>By signing up, you agree to our <a href="/terms">Terms of Service</a> and <a href="/privacy">Privacy Policy</a>
                    </footer>
                </div>;
    }
});
...
var Pssword = React.createClass({
    ...
    render: function () {
        ...
        if (this.props.twice){
            ch[1] = <input type="password" name="password2" required="required" placeholder="Repeat Password" onChange={this.onChange} key="password2"/>
        }
    ...
    render: function() {
        return <form method="post" accept-charset="utf-8" action="/u/login">
            ...
            <label htmlFor="remember-me">
                <input type="checkbox" name="remember_me" value="1" defaultChecked onChange={this.onChangeRemember} id="remember-me" />Remember me
            </label>   
            <p>
